...
public class DeleteServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement pst = conn.prepareStatement("delete from registry_entry where reid=?");
            pst.setString(1, id);
...
"                                        <div class=\"form-group\">\n" +
"                                            <label>ID</label>\n" +
"                                            <input class=\"form-control\" id=\"regentryid3\"/>\n" +
"                                           \n" +
"                                        </div>\n" +
"                                        <div class=\"form-group\">\n" +
"                                            <label>Scope</label>\n" +
"                                            <input class=\"form-control\" id=\"regentryscope3\"/>\n" +
"                                           \n" +
"                                        </div>\n" +
"                                        <div class=\"form-group\">\n" +
"                                            <label>Name</label>\n" +
"                                            <input class=\"form-control\" id=\"regentryname3\" placeholder=\"Example:com.express_scripts.services\" />\n" +
"                                        </div>\n" +
"                                        <div class=\"form-group\">\n" +
"                                            <label>Value</label>\n" +
"                                            <input class=\"form-control\" id=\"regentryvalue3\"placeholder=\"Example:ref_product_app_dev1\"/>\n" +
"                                        </div>\n" +
"        \n" +
"                                        <div class=\"form-group\">\n" +
"                                                <div class=\"checkbox\">\n" +
"                                                <label>\n" +
"                                                    <input type=\"checkbox\" id=\"regentryconfid3\" value=\"\" />Confidential\n" +
"                                                </label>\n" +
"                                            </div>\n" +
"                                        </div>\n" +
"\n" +
"                               \n" +
"                                        <button type=\"button\" class=\"btn btn-default\" id=\"regentryupdatebtn\">Update</button>\n" +
"                                        <button  class=\"btn btn-default\">Cancel</button>\n" +
"\n" +
"                                    </form>                         \n" +
"                                </div>\n" +
...
"                                        <div id=\"regentrymsg4\">ID not Exists</div>\n" +
"                                        <div class=\"form-group\" >\n" +
"                                            <label>ID</label>\n" +
...
"                                  \n" +
"                                    <form role=\"form\" method=\"post\" action=\"DeleteServlet\">\n" +
"                                        <div id=\"regentrymsg4\">Entry Deleted Successfully</div>\n" +
"                                        <div class=\"form-group\" >\n" +
"                                            <label>ID</label>\n" +
"                                            <input  type=\"text\" id=\"reid\" name=\"id\" class=\"form-control\"  />\n" +
"\n" +
